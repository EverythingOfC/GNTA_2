...
def society_welfare(): # 종로구 사회복지시설 데이터를 정제

    service_key = '744b676868746b66343063514a624f'
    url = "http://openapi.seoul.go.kr:8088/"+service_key+"/json/fcltOpenInfo_GN/1/66/1111000000" # 총 66개 데이터
